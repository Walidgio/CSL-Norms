...
<section id="rpa-p55" class="rpa-page rpa-scroll-spy-section" data-annotatable="true">
    ...
    <div class="mt-4">
        ...
        <div class="rpa-indent space-y-1">
            <div class="rpa-bullet">• <i>S, T<sub>2</sub></i> et <i>T<sub>3</sub></i> sont donnés dans les Tableaux (3.4) et (3.5)</div>
            <div class="rpa-bullet">• <i>&eta;</i> est donné par Eqn. (3.9)</div>
            <div class="rpa-bullet">• <i>d<sub>g</sub></i> est donné par Eqn. (3.10)</div>
            <div class="rpa-bullet">• Les périodes <i>T<sub>4</sub></i> et <i>T<sub>5</sub></i> sont les périodes de contrôle données dans le Tableau (3.7). La Figure (3.5) montre les formes des spectres en déplacement de Type 1 et de Type 2, pour les sols de classes <i>S<sub>1</sub></i> à <i>S<sub>4</sub></i> pour <i>&xi;</i> = 5%, normalisés par (A).</div>
        </div>
    </div>
    ...
    <div class="overflow-x-auto my-6">
        ...
        <div class="rpa-figure-title text-center mt-2" id="rpa-table-3.7">Table 3.7: Périodes de contrôle supplémentaires pour le spectre de déplacement</div>
    </div>
    ...
    <div id="rpa-art-3.3.2" class="mt-10">
        ...
        <p style="text-align: justify;">
            La composante verticale de l'action sismique doit être représentée par un spectre de réponse élastique, <math xmlns="http://www.w3.org/1998/Math/MathML"><mrow><mfrac><msub><mi>S</mi><mrow><mi>v</mi><mi>e</mi></mrow></msub><mi>g</mi></mfrac><mo>(</mo><mi>T</mi><mo>)</mo></mrow></math>, donné par Eqn. (3.14) :
        </p>
    </div>
</section>
